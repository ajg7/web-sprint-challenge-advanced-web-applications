...
1. Explain what a token is used for.
  A token is a string that allows access to protected routes

2. What steps can you take in your web apps to keep your data secure?
  Use private routes that requires a token to access

3. Describe how web servers work.
  You make a request to obtain a website or JSON, and then the server grabs it and sends it back to you.
